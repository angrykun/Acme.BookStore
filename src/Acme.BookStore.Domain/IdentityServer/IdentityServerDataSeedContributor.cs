...
namespace Acme.BookStore.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            {
                var blazorServerTieredClientRootUrl = configurationSection["BookStore_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');

                /* BookStore_BlazorServerTiered client is only needed if you created a tiered blazor server
                ...
                await CreateClientAsync(
                    ...
                    scopes: commonScopes,
                    grantTypes: new[] { "hybrid" },
                    secret: (configurationSection["BookStore_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*").Sha256(),
